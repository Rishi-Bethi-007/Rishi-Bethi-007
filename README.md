<!--
**Rishi-Bethi-007/Rishi-Bethi-007** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
→ [**Live Demo**](https://youtube-multi-video-playlist-rag-be5fqxqp9w7rvcffmlp3dk.streamlit.app/)
...
## 🛠️ Core Stack
```
LLMs & Agents    │ OpenAI, LangChain, LangGraph
Vector Storage   │ Pinecone, pgvector
Databases        │ PostgreSQL, SQLite, Redis
Evaluation       │ RAGAS, LLM-as-judge, latency profiling
Infrastructure   │ Docker, Streamlit Cloud, Neon, Upstash
Languages        │ Python
```
...
**EU Regulatory Intelligence Agent** — A multi-agent system helping EU SMEs navigate AI Act compliance, built with GDPR-aware architecture, EU AI Act risk classification, and multilingual NLP (Swedish/German).

---

## 📫 Let's Connect

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Rishi_Bethi-blue)]([https://linkedin.com/in/your-profile](https://www.linkedin.com/in/rishi-kumar-bethi/))
